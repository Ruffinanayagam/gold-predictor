...
@st.cache_resource
def load_and_train():
    df = pd.read_csv(r"C:\Users\Antonyruffi\Downloads\gold_streamlit (1)\gold_predictor\Gold_Futures_Historical_Data__4_.csv")
...
with tab1:
    ...
    if st.button("🔮 Run Prediction", type="primary", use_container_width=True):
        ...
        # Combined chart: last 60 days + prediction
